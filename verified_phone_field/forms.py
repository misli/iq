...
from django.forms.fields import CharField, MultiValueField, DecimalField
from django.utils.translation import ugettext_lazy as _

from .fieldsetup import VerifiedPhoneFieldSetup, fieldsetups
...
class VerifiedPhoneField(MultiValueField):
    ...
    def clean(self, value):
        ...
        if email:
            if not valid_code:
                ...
                raise ValidationError(_('The verification code has been sent to your phone number.'))
            else:
                if not code:
