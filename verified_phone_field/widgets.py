...
from django.forms.widgets import NumberInput, MultiWidget, TextInput
from django.templatetags.static import static
from django.utils.html import format_html


class VerifiedEmailWidget(MultiWidget):
    template_name = 'verified_phone_field/field.html'
    ...
    def __init__(self, send_label, fieldsetup_id, email_attrs, code_attrs):
        ...
        widgets = (NumberInput(attrs=email_attrs), TextInput(attrs=code_attrs))
